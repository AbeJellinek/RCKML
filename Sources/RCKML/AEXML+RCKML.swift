...
extension AEXMLElement {
    ...
    convenience init<K: KMLObject>(baseFor kmlElement: K.Type, id: String?) {
    ...
    ///
    /// - Parameter type: the Swift type (implementing KMLObject protocol) of the returned child.
    ...
    func requiredKmlChild<T: KMLObject>(ofType type: T.Type) throws -> T {
    ...
    func optionalKmlChild<T: KMLObject>(ofType type: T.Type) -> T? {
    ...
    ///
    /// - Parameter type: The Swift type (implementing KMLObject protocol) of the returned children.
    /// - Throws: KMLErrors generated by `KMLObject.init(xml:)` calls.
    /// - Returns: An array of KMLElement type `type`
    func allKmlChildren<T: KMLObject>(ofType type: T.Type) throws -> [T] {
